...
#  Generated on:      Sat May  2 20:24:26 2020
#  Design:            mtm_Alu
#  Command:           write_db mtm_Alu
###############################################################
current_design mtm_Alu
set_clock_gating_check -rise -setup 0 
set_clock_gating_check -fall -setup 0 
create_clock [get_ports {clk}]  -name clk1 -period 20.000000 -waveform {0.000000 10.000000}
...
set_input_delay -add_delay 10 -clock [get_clocks {clk1}] [get_ports {rst_n}]
set_input_delay -add_delay 10 -clock [get_clocks {clk1}] [get_ports {sin}]
set_output_delay -add_delay 10 -clock [get_clocks {clk1}] [get_ports {sout}]
