...
# read_hdl 
read_hdl ../rtl/mtm_Alu_deserializer.v ../rtl/mtm_Alu_core.v ../rtl/mtm_Alu_serializer.v ../rtl/mtm_Alu.v
...
puts "--------------------------------------------------------------------------------"
check_timing_intent -verbose > check_timing_intent.rpt
...
write_design -innovus -basename $resultDir/mtmAlu
